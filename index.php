...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <main class="site-wrap" id="home-section">
    <?php get_header() ?>
    <section class="site-blocks-cover" style="overflow: hidden">
      <div class="container">
    ...
    <section class="site-section" id="features-section">
      <div class="container">
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="unit-4 d-block">
              ...
              <div>
                <h3>UX/UI & Graphics Design Services</h3>
                <p>
        ...
        <div class="row mb-5 site-section">
          ...
          <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
            ...
            <div class="author-box" data-aos="fade-left">
              ...
              <blockquote>
                &ldquo;"I had a great experience with the Brainstorm Bonanza team! They really took the time to understand my vision and goals, and came up with creative ideas that I would have never thought of on my own. I felt like I was part of the process the whole way through, and it really paid off in the end!&rdquo;
              </blockquote>
            </div>
          </div>
        </div>
        <div class="mt-5 row mb-5 site-section">
          ...
          <div class="col-lg-5 pr-lg-5 mr-auto mt-5 order-2 order-lg-1">
            ...
            <div class="author-box" data-aos="fade-right">
              ...
              <blockquote>
                &ldquo;The Design Delight team knocked it out of the park! I was blown away by their ability to capture the essence of my brand and create a design that was both stunning and functional. They were able to take my feedback and make adjustments until it was perfect. I've received so many compliments on the design, and it's all thanks to this amazing team!&rdquo;
              </blockquote>
            </div>
          </div>
        </div>
        <div class="row mb-5 site-section">
          ...
          <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
            ...
            <div class="author-box" data-aos="fade-left">
              ...
              <blockquote>
                &ldquo;The Development Dynamo team really knows their stuff! They were able to take the design and turn it into a fully functional web app that exceeded my expectations. They were always available to answer my questions and give me updates on the progress. I can't imagine going through this process with anyone else!&rdquo;
              </blockquote>
            </div>
          </div>
        </div>
        <div class="mt-5 row mb-5 site-section">
          ...
          <div class="col-lg-5 pr-lg-5 mr-auto mt-5 order-2 order-lg-1">
            ...
            <div class="author-box" data-aos="fade-right">
              ...
              <blockquote>
                &ldquo;The Launch Party was amazing! It was so exciting to finally see my web app come to life and be available to the world. The team made sure everything was running smoothly and that all of the final touches were in place. They really made me feel like a VIP and I couldn't be happier with the end result. Thank you!&rdquo;
              </blockquote>
            </div>
          </div>
        </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-5 ml-auto pl-lg-5">
            ...
            <ul class="ul-check list-unstyled success">
              <li>Empowering our clients with innovative and creative solutions that are tailored to their unique needs.</li>
              <li>Delivering a seamless and hassle-free development experience, from ideation to launch and beyond.</li>
              <li>Ensuring that our clients stay ahead of the curve with cutting-edge technology and expert support.</li>
            </ul>
            <p class="mb-5">
              Our ultimate goal is to help businesses thrive in the digital age, and we're committed to achieving that through our passion for technology and our dedication to excellence.
            </p>
    ...
    <section class="site-section" id="our-team-section">
      <div class="container">
        <div class="row mb-5 justify-content-center text-center" data-aos="fade-up">
          <div class="col-7 text-center mb-5">
    ...
    <section class="site-section bg-image2 overlay" id="contact-section" style="background-image: url('images/hero_1.jpg')">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
